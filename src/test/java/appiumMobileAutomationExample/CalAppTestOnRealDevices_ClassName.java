...
public class CalAppTestOnRealDevices_ClassName {
...
//		caps.setCapability("appActivity", "com.android.dialer.main.impl.MainActivity");
	...
	public void addThreeDigitTest() throws Exception {
		...
		driver.findElement(By.xpath("//android.widget.Button[@index='17']")).click();	// 8
		
		driver.findElement(By.xpath("//android.widget.Button[@text='5']")).click();		//5
