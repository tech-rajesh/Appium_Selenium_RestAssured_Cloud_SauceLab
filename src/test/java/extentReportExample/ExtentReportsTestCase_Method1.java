...
public class ExtentReportsTestCase_Method1 {
	...
	public void startReport() {
		...
		htmlReporter = new ExtentHtmlReporter("./test-output/TCS_9May_ExtentReport"+dateName_number+".html");
		...
		extent.setSystemInfo("ProjectName", "Functional Test Automation - Web / Mobile");
		...
		// Name of the report
		htmlReporter.config().setReportName("Functional Regression Report");
		// Dark Theme
